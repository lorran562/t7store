    ...
    <>
      <header style={{
        ...
        <a href="/" style={{ display: "flex", alignItems: "center", gap: "8px", textDecoration: "none", flexShrink: 0 }}>
          ...
          <span style={{ fontFamily: "var(--font-display)", fontSize: "1.4rem", letterSpacing: "2px", background: "linear-gradient(135deg,#fff 30%,#f5c800)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", whiteSpace: "nowrap" }}>
            T7 STORE
          </span>
        </a>
        ...
        <nav style={{ flex: 1, display: "flex", justifyContent: "center", gap: "1.6rem" }} className="hidden md:flex">
          {["Produtos", "Contato"].map(item => (
            <a key={item} href={`#${item.toLowerCase()}`}
              style={{ fontFamily: "var(--font-body)", fontWeight: 700, fontSize: "0.88rem", letterSpacing: "1px", textTransform: "uppercase", color: "var(--white)", textDecoration: "none" }}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginLeft: "auto" }}>
          ...
          <button onClick={openCart} style={{ background: "var(--green)", border: "none", borderRadius: "8px", padding: "8px 14px", fontFamily: "var(--font-body)", fontWeight: 700, fontSize: "0.85rem", letterSpacing: "1px", color: "#fff", cursor: "pointer", display: "flex", alignItems: "center", gap: "7px", minHeight: "40px" }}
          ...
          <nav style={{ background: "var(--dark2)", borderBottom: "1px solid rgba(255,255,255,0.1)", padding: "12px 0" }} onClick={e => e.stopPropagation()}>
            {[{ label: "Produtos", href: "#produtos" }, { label: "Contato", href: "#contato" }].map(item => (
              <a key={item.label} href={item.href} onClick={handleNav}
                style={{ display: "block", padding: "16px 24px", fontFamily: "var(--font-body)", fontWeight: 700, fontSize: "1.1rem", letterSpacing: "1px", textTransform: "uppercase", color: "#fff", textDecoration: "none", borderBottom: "1px solid rgba(255,255,255,0.06)" }}
